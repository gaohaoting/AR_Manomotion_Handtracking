...
public class ARCubeInteraction : MonoBehaviour
{
    ...
    private void Update()
    {
        if (ManomotionManager.Instance.HandInfos[0].trackingInfo.skeleton.confidence < skeletonConfidenceThreshold)
        {
            cubeRenderer.sharedMaterial = arCubeMaterial[0];
        }
    }
    ...
    {
        if (ManomotionManager.Instance.HandInfos[0].gestureInfo.manoGestureContinuous == grab)
        {
    ...
    {
        if (ManomotionManager.Instance.HandInfos[0].gestureInfo.manoGestureContinuous == pinch)
        {
    ...
    {
        if (ManomotionManager.Instance.HandInfos[0].gestureInfo.manoGestureTrigger == click)
        {
