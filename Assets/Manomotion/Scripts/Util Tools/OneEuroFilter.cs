...
// -----------------------------------------------------------------
/// <summary>
/// One Euro Filter implementation to reduce jittering
/// Credit: Dario Mazzanti https://github.com/DarioMazzanti/OneEuroFilterUnity
/// </summary>
class OneEuroFilter
{
	float freq;
	...
	public OneEuroFilter(OneEuroFilterSetting setting) : this(setting.freq, setting.mincutoff, setting.beta, setting.dcutoff)
	{
...
public class OneEuroFilter<T> where T : struct
{
    ...
    public void UpdateParams(float _freq, float _mincutoff = 1.0f, float _beta = 0.007f, float _dcutoff = 1.0f)
	{
		freq = _freq;
		mincutoff = _mincutoff;
		beta = _beta;
    ...
    public void UpdateParams(OneEuroFilterSetting setting)
    {
		UpdateParams(setting.freq, setting.mincutoff, setting.beta, setting.dcutoff);
    }
