...
public class ManoCursorUIOverlay : MonoBehaviour
{
    #region Singleton Region
    private static ManoCursorUIOverlay _instance;
    public static ManoCursorUIOverlay Instance
    {
        get
        {
            return _instance;
    ...
    void Update()
    {
        ...
        {
            //Debug.Log("Pointer position " + ManomotionManager.Instance.Hand_infos[0].hand_info.tracking_info.skeleton.joints[8]);
            //Debug.Log(DrawApplicationManager.Instance.currentState);
