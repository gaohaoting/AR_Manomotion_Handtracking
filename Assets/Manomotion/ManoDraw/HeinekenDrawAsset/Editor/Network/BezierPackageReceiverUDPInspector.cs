...
[CustomEditor(typeof(BezierPackageReceiverUDP))]
public class BezierPackageReceiverUDPInspector : Editor {

	private BezierPackageReceiverUDP receiver;
	...
	public override void OnInspectorGUI() {
		...
		receiver = target as BezierPackageReceiverUDP;
		...
		if (receiver.networkReceiver != null) {
			...
			GUILayout.Space (20);
			GUILayout.Label ("Status : " + receiver.networkReceiver.Status);
