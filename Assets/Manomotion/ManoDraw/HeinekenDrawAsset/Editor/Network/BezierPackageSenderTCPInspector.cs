...
[CustomEditor(typeof(BezierPackageSenderTCP))]
public class BezierPackageSenderTCPInspector : Editor {

	private BezierPackageSenderTCP sender;
	...
	public override void OnInspectorGUI() {
		...
		sender = target as BezierPackageSenderTCP;
