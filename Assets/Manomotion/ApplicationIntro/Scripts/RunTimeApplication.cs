    ...
    public class RunTimeApplication : MonoBehaviour
    {
        ...
        public void InitializeRuntimeComponents()
        {
            ...
            if (!manomotionManager)
            {
                try
                {
                    manomotionManager = FindObjectOfType<ManomotionManager>();
                }
                catch (Exception)
                {
        ...
        public void ShouldShowBackground(bool condition)
        {
            ...
            manoVisualization.ShowBackground = condition;
        }
        ...
        /// <summary>
        /// Sets if one or two hands should be calculated.
        /// </summary>
        /// <param name="condition">If set to <c>true</c> condition.</param>
        public void ShouldRunTwoHands(bool condition)
        {
            ...
            manomotionManager.ShouldRunTwoHands(condition);
            gizmoManager.TwoHands = condition;
        }
        ...
        public void SaveDefalutFeaturesToDisplay()
        {
            ...
            showBackground = manoVisualization.ShowBackground;
            ...
            runTwoHands = gizmoManager.TwoHands;
            ...
            if (runTwoHands)
            {
                defaultFunctionality.Add(UIIconBehavior.IconFunctionality.TwoHands);
            }
        }
